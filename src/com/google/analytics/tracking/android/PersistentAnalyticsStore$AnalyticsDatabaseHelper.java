  ...
  extends SQLiteOpenHelper
{
  ...
  private boolean a(String paramString, SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   80: invokestatic 113	com/google/analytics/tracking/android/Log:d	(Ljava/lang/String;)V
    //   83: aload 6
    //   85: ifnull +10 -> 95
    //   88: aload 6
    ...
    //   0	141	0	this	AnalyticsDatabaseHelper
  ...
  {
    if ((this.b) && (3600000L + this.c > PersistentAnalyticsStore.a(this.a).a())) {
      throw new SQLiteException("Database creation failed");
    }
    this.b = true;
    this.c = PersistentAnalyticsStore.a(this.a).a();
    try
    {
    ...
    catch (SQLiteException localSQLiteException)
    {
      for (;;)
      {
        PersistentAnalyticsStore.c(this.a).getDatabasePath(PersistentAnalyticsStore.b(this.a)).delete();
  ...
  public void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    try
    {
      ...
      {
        paramSQLiteDatabase.execSQL(PersistentAnalyticsStore.e());
        return;
      }
    }
    finally
