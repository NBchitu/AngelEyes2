  ...
  extends Z
{
  ...
  private static ay a(ay paramay, b paramb)
  {
    ...
    try
    {
      localInputStream = v.a().w().getResources().openRawResource(paramb.j.b);
  ...
  {
    ay localay = a(b().a("X-CRASHLYTICS-API-KEY", paramb.a).a("X-CRASHLYTICS-API-CLIENT-TYPE", "android").a("X-CRASHLYTICS-API-CLIENT-VERSION", v.a().f()), paramb);
